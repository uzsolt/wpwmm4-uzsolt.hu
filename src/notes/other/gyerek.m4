  ...
  _HREF(`https://www.nav.gov.hu/nav/ado/szja/A_csaladi_kedvezmeny_20170105.html',
    ...
    `_UL(
      ...
      `leegyszerűsítve: havonta <em>eltartottanként</em> az alábbi összegekkel
        ...
        a nyugdíjjárulék (_HREF(`https://net.jogtar.hu/jogszabaly?docid=99500117.TV#pr594id',``SZJA-törvény, 29/A. §'')):'
        `_UL(
...
_UL(
  ...
  `az apának születéskor a második hónap végéig öt nap pótszabadság jár
    (_HREF(`https://net.jogtar.hu/jogszabaly?docid=A1200001.TV#pr775id',``Munka törvénykönyve, 118. § (4)''))'
)
